...
const Hero = () => {
  return (
    <div className=" min-h-screen px-8 p-20 relative">
      <Logo_max />
      <div className=" p-6 flex min-h-[80vh]  justify-between items-center">
        <div>
          <h1 className="text-[3.3em] font-black mb-2 uppercase leading-[1em] text-indigo-900">
